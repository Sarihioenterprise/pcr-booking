      ...
      <nav className="sticky top-0 z-50 border-b border-[#E5E7EB] bg-white/95 backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/auth/login"
              className="hidden text-sm text-[#6B7280] transition-colors hover:text-[#374151] sm:block"
            >
              Login
            </Link>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-12 flex flex-col gap-4">
            {faqs.map((faq) => (
              <Card
                key={faq.question}
                className="bg-white ring-1 ring-[#E5E7EB] shadow-sm"
              >
                <CardContent className="py-1">
                  <h3 className="text-base font-semibold text-[#080812]">
                    {faq.question}
                  </h3>
