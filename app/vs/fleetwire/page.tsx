...
const tableRows = [
  ...
  },
  {
    ...
    competitor: { icon: "warn", text: "$24/mo but per-car fees" },
  },
  {
    feature: "Built for private car rental",
    pcr: { icon: "check", text: "Yes" },
    competitor: { icon: "warn", text: "Turo-ecosystem focused" },
  },
  {
    feature: "Digital agreements",
    pcr: { icon: "check", text: "Included" },
    competitor: { icon: "x", text: "Limited" },
  },
  {
    feature: "Automated collections/dunning",
    pcr: { icon: "check", text: "Built in" },
    competitor: { icon: "x", text: "Not included" },
  },
  {
  ...
  {
    feature: "Renter blacklist protection",
    pcr: { icon: "check", text: "Yes" },
    competitor: { icon: "x", text: "No" },
  },
  {
...
export default function FleetwireAlternativePage() {
  return (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-lg p-3" style={{ backgroundColor: "rgba(255,255,255,0.04)" }}>
                    <p className="text-xs font-bold mb-2 text-white/50">FleetWire</p>
                    <div className="flex items-center gap-1.5">
                      <CellIcon icon={row.competitor.icon} />
