...
const tableRows = [
  ...
  },
  {
    ...
    competitor: { icon: "x", text: "$49+/mo" },
  },
  {
    feature: "Per-booking commission",
    pcr: { icon: "check", text: "None — keep 100%" },
    competitor: { icon: "warn", text: "Varies by plan" },
  },
  {
  ...
  },
  {
    ...
    competitor: { icon: "warn", text: "Basic" },
  },
  {
  ...
  },
  {
    ...
    competitor: { icon: "check", text: "Month to month" },
  },
  {
    feature: "Collections / late fee automation",
    pcr: { icon: "check", text: "Automated SMS dunning" },
    competitor: { icon: "x", text: "Manual" },
  },
];
...
export default function FleetFinesseAlternativePage() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#080812", color: "#fff" }}>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-20 pb-24 text-center">
        ...
        >
          FleetFinesse Alternative
        </div>
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-6">
          Looking for a{" "}
          <span style={{ color: "#2EBD6B" }}>FleetFinesse Alternative?</span>
        </h1>
        <p className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto mb-10">
          FleetFinesse is a solid tool — but PCR Booking starts free, charges zero commission,
          and includes automated collections, renter blacklists, and AI support that FleetFinesse
          simply doesn&apos;t have.
        </p>
        <Link href="/auth/signup">
          <Button
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-lg p-3" style={{ backgroundColor: "rgba(255,255,255,0.04)" }}>
                    <p className="text-xs font-bold mb-2 text-white/50">FleetFinesse</p>
                    <div className="flex items-center gap-1.5">
                      <CellIcon icon={row.competitor.icon} />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="mt-4 text-white/70 text-base sm:text-lg leading-relaxed">
              PCR Booking charges a flat monthly fee — no per-booking commissions, no
              percentage of revenue taken. Every dollar your renters pay goes straight to you.
            </p>
          </div>
        </div>
      </section>
