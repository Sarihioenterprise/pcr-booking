...
const tableRows = [
  ...
  },
  {
    ...
    competitor: { icon: "x", text: "Enterprise quotes only" },
  },
  {
    feature: "Built for independent operators",
    pcr: { icon: "check", text: "Yes" },
    competitor: { icon: "x", text: "Enterprise/franchise focus" },
  },
  {
    feature: "Setup time",
    pcr: { icon: "check", text: "Under 10 minutes" },
    competitor: { icon: "x", text: "Weeks of onboarding" },
  },
  {
    feature: "No long-term contract",
    pcr: { icon: "check", text: "Cancel anytime" },
    competitor: { icon: "x", text: "Multi-year contracts" },
  },
  {
  ...
  },
  {
    ...
    competitor: { icon: "x", text: "Sales process required" },
  },
];
...
export default function ThermeonAlternativePage() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#080812", color: "#fff" }}>
      ...
      <section className="max-w-5xl mx-auto px-4 pt-20 pb-24 text-center">
        ...
        >
          Thermeon Alternative
        </div>
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-6">
          Looking for a{" "}
          <span style={{ color: "#2EBD6B" }}>Thermeon Alternative?</span>
        </h1>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-lg p-3" style={{ backgroundColor: "rgba(255,255,255,0.04)" }}>
                    <p className="text-xs font-bold mb-2 text-white/50">Thermeon</p>
                    <div className="flex items-center gap-1.5">
                      <CellIcon icon={row.competitor.icon} />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <p className="text-2xl sm:text-3xl font-extrabold leading-snug" style={{ color: "#2EBD6B" }}>
              🏢 Enterprise software for an independent business? Hard pass.
            </p>
            <p className="mt-4 text-white/70 text-base sm:text-lg leading-relaxed">
              Thermeon was built for Hertz and Budget-level operations. If you&apos;re running
              1–50 cars independently, you&apos;re paying for complexity you don&apos;t need.
              PCR Booking starts <strong className="text-white">free</strong> and scales with you.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4" style={{ backgroundColor: "#080812" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-5">
            {[
              "Thermeon requires a sales process, a demo, and a multi-year contract before you can touch the software. PCR Booking is self-serve — sign up now and have your fleet running today.",
              "Thermeon is priced and built for enterprise. Independent operators end up paying for features built for franchise networks while missing the tools they actually need day-to-day.",
              "PCR Booking includes renter blacklists, automated SMS dunning for late payments, and 24/7 AI support — all built for the realities of running a private rental car business.",
            ].map((point, i) => (
              <div
                key={i}
