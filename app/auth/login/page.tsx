...
export default function LoginPage() {
  ...
  async function handleForgotPassword(e: React.FormEvent) {
    ...
    // Always show this message regardless of whether the email exists —
    // avoids leaking account-enumeration information.
    setForgotSent(true);
  }
              ...
              {forgotSent ? (
                <div className="grid gap-4">
                  <p className="text-sm text-muted-foreground">
                    If an account exists for that email, a reset link is on the
                ...
                <div className="grid gap-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-xs text-[#2EBD6B] hover:underline focus:outline-none"
                    >
                      Forgot password?
                    </button>
                  </div>
